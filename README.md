[![Release](https://img.shields.io/badge/release-v0.2.0-blue.svg)](https://github.com/scaleflex/react-cloudimage-responsive-blur-hash/releases)
...
- **Blur Hash**
- [**Plain (CSS free)**](https://github.com/scaleflex/react-cloudimage-responsive-plain)
